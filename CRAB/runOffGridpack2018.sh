...
do
    ...
    cmsDriver.py Configuration/GenProduction/python/${HADRONIZER}_ctau-${ctau_mm}.py \
        ...
        --conditions auto:phase1_2018_realistic --beamspot Realistic25ns13TeVEarly2018Collision \
        --step GEN,SIM --era Run2_2018 --nThreads 8 \
    ...
    cmsDriver.py step1 \
        ...
        --mc --step DIGI,L1,DIGI2RAW,HLT:2018v32 \
    ...
    cmsDriver.py step2 \
        ...
        --conditions auto:phase1_2018_realistic --step RAW2DIGI,L1Reco,RECO \
