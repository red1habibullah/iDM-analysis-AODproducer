...
do
    ...
    cmsDriver.py Configuration/GenProduction/python/${HADRONIZER}_ctau-${ctau_mm}.py \
        ...
        --conditions 94X_mc2017_realistic_v11 --beamspot Realistic25ns13TeVEarly2017Collision \
        --step GEN,SIM --era Run2_2017 --nThreads 1 \
    ...
    cp ${BASEDIR}/DIGIRAWHLT_template_2017.py .
    sed -i "s/file:placeholder_in.root/file:${namebase}_GENSIM_ctau-${ctau_mm}.root/g" DIGIRAWHLT_template_2017.py
    sed -i "s/file:placeholder_out.root/file:${namebase}_DIGIRAWHLT_ctau-${ctau_mm}.root/g" DIGIRAWHLT_template_2017.py
    sed -i "s/input = cms.untracked.int32(10)/input = cms.untracked.int32(${nevent})/g" DIGIRAWHLT_template_2017.py
    mv DIGIRAWHLT_template_2017.py ${namebase}_DIGIRAWHLT_cfg_ctau-${ctau_mm}.py
